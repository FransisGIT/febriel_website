...
export default function Home() {
    return (
        <div className="min-h-screen w-full flex py-52 justify-center p-4 relative overflow-y-auto overflow-x-hidden">
            {/* Floating particles */}
            ...
            <div className="w-full max-w-2xl bg-slate-800/40 backdrop-blur-xl rounded-2xl p-5 shadow-xl text-white relative z-10">
